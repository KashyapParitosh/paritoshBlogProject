const ListOfBlogData = [
{
  id : 0,
  author : "Paritosh Kashyap",
  title : "What makes the Bollywood title song eternal",
  ImgUrl : "https://media.istockphoto.com/photos/bollywood-picture-id689019358",
  desc : "The title song is amongst the many subgenres that exist in the delightful world of Hindi film music, especially till the mid-70s. Though not extinct yet, they are certainly on their way out.",
  category: "Bollywood",
...

{
    ...
    ImgUrl: "https://images.unsplash.com/photo-1589053739346-ed32227546a4?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1031&q=80",
...

{
    ...
    title : "'Shelf Life' In Bollywood After Marriage",
    ImgUrl : "https://www.bollywoodshaadis.com/img/article-l-20211132216360759767000.jpg",
...
{
    id: 12,
    author: "Ryan Honeycutt",
    ImgUrl: "https://th.bing.com/th/id/OIP.sae3mMCv-x2Ea8XtGfEhBgHaLH?pid=ImgDet&rs=1",
    title: "Manifest Season 4 Release Date,",
    desc: "Created by Jeff Rake for NBC, ‘Manifest’ is a supernatural drama that follows the Montego Air Flight 828, which mysteriously lands in New York after five and a half years’ disappearance. The series progresses through the lives of the passengers, who were presumed dead, and the changes they encounter in themselves as they begin to experience guiding voices and visions of the future. Referred to as callings, these voices and visions help them unravel not only the future but also the mystery behind the aircraft.",
    category: "Hollywood",
